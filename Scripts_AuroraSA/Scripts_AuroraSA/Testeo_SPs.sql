...
EXEC spAuroraSA.ClienteEliminar @tipoCliente = 'Vip';
	...
	-- ACTUALIZACION
	-- DA OK (DADO DE ALTA)
EXEC spAuroraSA.ClienteActualizar @id = 2, @activo = 1;
	-- FALLA PORQUE NO EXISTE ID
...
EXEC spAuroraSA.EmpleadoInsertar @idSucursal = 2, @nombre = 'Gonzalo', @apellido = 'Casas',@dni = 44004892,	@direccion = 'AAA 123', 
								@emailEmpre = 'AAA@aaa.com',@cargo = 'Supervisor';
...
EXEC spAuroraSA.EmpleadoActualizar @dni = 44004892, @idSucursal = 2,@activo = 1;
...
-- INSERCION
	-- DA OK
EXEC spAuroraSA.MedioPagoInsertar @nombreEN = 'Cash', @nombreES = 'Efectivo';
	-- FALLA POR DUPLICADO
EXEC spAuroraSA.MedioPagoInsertar @nombreEN = 'Cash', @nombreES = 'Efectivo';
...
EXEC spAuroraSA.ProductoInsertar @idCatalogo = 3, @nombre = 'Leche',@categoria = 'Lacteo',@precioUnitario = 10.5,
	@precioReferencia = 12.6, @unidadReferencia = 'LT',@proveedor = 'Carlos',@cantPorUnidad = '1';
...
EXEC spAuroraSA.ProductoActualizar @id = 5, @activo = 1;
	-- FALLA PORQUE NO EXISTE CATALOGO.
EXEC spAuroraSA.ProductoActualizar @id = 1,@idCatalogo = 3, @activo = 1;
...
-- INSERCION
	-- DA OK
EXEC spAuroraSA.TurnoInsertar @nombre = 'Maniana', @horaIni = '08:00:00', @horaFin = '12:00:00';
	-- FALLA POR DUPLICADO
EXEC spAuroraSA.TurnoInsertar @nombre = 'Maniana', @horaIni = '08:00:00', @horaFin = '12:00:00';
...
EXEC spAuroraSA.VentaInsertar	@idFactura = '011-011-111', @tipoFactura = 'A', 
								@idCliente = 2, @idEmpleado = 400000, @idSucursal = 1, 
								@idMedioPago = 1, @identificaPago = 'Pago01', @idProducto = 1, 
								@genero = 'Male', @cantidad = 5, @precioUnitario = 20.50;
	-- FALLA POR CLIENTE INEXISTENTE
EXEC spAuroraSA.VentaInsertar	@idFactura = '011-011-111', @tipoFactura = 'A', 
								@idCliente = 5, @idEmpleado = 400000, @idSucursal = 1, 
								@idMedioPago = 1, @identificaPago = 'Pago01', @idProducto = 1, 
								@genero = 'Male', @cantidad = 5, @precioUnitario = 20.50;
...
EXEC spAuroraSA.VentaInsertar	@idFactura = '011-011-111', @tipoFactura = 'A', 
								@idCliente = 2, @idEmpleado = 400000, @idSucursal = 1, 
								@idMedioPago = 5, @identificaPago = 'Pago01', @idProducto = 1, 
								@genero = 'Male', @cantidad = 5, @precioUnitario = 20.50;
...
EXEC spAuroraSA.VentaInsertar	@idFactura = '011-011-111', @tipoFactura = 'A', 
	...
	-- ELIMINACION
	-- DA OK
EXEC spAuroraSA.VentaEliminar @idVenta = 1, @motivo = 'Cancelación de pedido';
	-- FALLA PORQUE NO EXISTE LA VENTA.
EXEC spAuroraSA.TurnoEliminar @idVenta = 999, @motivo = 'Error en facturación';
